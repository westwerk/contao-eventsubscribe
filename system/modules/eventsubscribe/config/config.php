 ...
 * 
 * @package   calendarFields 
 * @author    Pascal Diener 
 * @license   GNU/LGPL 
 ...
 */
 ...
 /**
 * Einfügen einer weiteren Tabelle für das subscribe
 */
$GLOBALS['BE_MOD']['content']['eventsubscribe'] = array(
	'tables' 	=> array('tl_calendar_events_subscribe'),
	'icon' 		=> 'system/modules/eventsubscribe/assets/icon.gif'
);
...
$GLOBALS['FE_MOD']['eventsubscribe']['module_eventsubscribe'] = 'EventSubscribeFrontend';
...
$GLOBALS['BE_FFL']['selectevent'] = 'SelectEventMenu';
 ...
 */
 ...
 $GLOBALS['TL_FFL']['selectevent'] = 'FormSelectEventMenu';
...
$GLOBALS['TL_HOOKS']['processFormData'][]   = array('EventSubscribe','myProcessFormData');
$GLOBALS['TL_HOOKS']['replaceInsertTags'][] = array('EventSubscribe','myReplaceInsertTags');
$GLOBALS['TL_HOOKS']['validateFormField'][] = array('EventSubscribe','myValidateFormField');
$GLOBALS['TL_HOOKS']['simpleAjax'][] 		= array('EventSubscribeAjax', 'ajaxSelect');
